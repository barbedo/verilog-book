...
#
# bin2bcd.tcl: Tcl script for re-creating project 'bin2bcd'
#
...
# Create project
create_project bin2bcd $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/bin2bcd_test.v"]"\
]
...
puts "INFO: Project created:bin2bcd"
