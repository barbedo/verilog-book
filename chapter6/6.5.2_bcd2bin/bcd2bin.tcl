...
#
# bcd2bin.tcl: Tcl script for re-creating project 'bcd2bin'
#
...
# Create project
create_project bcd2bin $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/bcd2bin_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "bin2bcd_test" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/bcd2bin_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property "top" "bcd2bin_tb" $obj
...
puts "INFO: Project created:bcd2bin"
