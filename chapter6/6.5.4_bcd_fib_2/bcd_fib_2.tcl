...
#
# bcd_fib_2.tcl: Tcl script for re-creating project 'bcd_fib_2'
#
...
# Create project
create_project bcd_fib_2 $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects bcd_fib_2]
...
puts "INFO: Project created:bcd_fib_2"
