...
#
# period_counter.tcl: Tcl script for re-creating project 'period_counter'
#
...
set script_file "period_counter.tcl"
...
# Create project
create_project period_counter $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects period_counter]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/period_counter_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "period_counter_test" $obj
...
puts "INFO: Project created:period_counter"
