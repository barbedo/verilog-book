...
#
# babbage_engine.tcl: Tcl script for re-creating project 'babbage_engine'
#
...
set _xil_proj_name_ "babbage_engine"
...
set script_file "babbage_engine.tcl"
...
set files [list \
 [file normalize "${origin_dir}/design/babbage_engine_f.v"] \
 [file normalize "${origin_dir}/design/babbage_engine_h.v"] \
 [file normalize "${origin_dir}/design/bin2bcd.v"] \
 [file normalize "${origin_dir}/design/debounce.v"] \
 [file normalize "${origin_dir}/design/disp_hex_mux.v"] \
 [file normalize "${origin_dir}/design/babbage_engine_top.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "babbage_engine_top" -objects $obj
