...
#
# division.tcl: Tcl script for re-creating project 'division'
#
...
# Create project
create_project division $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/div_test.v"]"\
]
...
puts "INFO: Project created:division"
