...
#
# fibonacci.tcl: Tcl script for re-creating project 'fibonacci'
#
...
# Create project
create_project fibonacci $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects fibonacci]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/fib_test.v"]"\
]
...
puts "INFO: Project created:fibonacci"
