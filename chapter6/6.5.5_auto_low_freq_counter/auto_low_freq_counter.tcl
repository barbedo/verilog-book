...
set _xil_proj_name_ "auto_low_freq_counter"
...
set files [list \
 [file normalize "${origin_dir}/src/design/auto_low_freq_counter.v"] \
 [file normalize "${origin_dir}/src/design/bcd_adjust.v"] \
 ...
 [file normalize "${origin_dir}/src/design/auto_low_freq_counter_test.v"] \
]
