...
#
# alt_bcd_counter.tcl: Tcl script for re-creating project 'alt_bcd_counter'
#
...
set _xil_proj_name_ "alt_bcd_counter"
...
set script_file "alt_bcd_counter.tcl"
...
set files [list \
 ...
 [file normalize "${origin_dir}/design/stop_watch_if.v"] \
 [file normalize "${origin_dir}/design/stop_watch_test.v"] \
 [file normalize "${origin_dir}/design/stop_watch_cascade.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "stop_watch_test" -objects $obj
