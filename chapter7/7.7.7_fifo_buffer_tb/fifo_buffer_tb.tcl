...
#
# fifo_buffer_tb.tcl: Tcl script for re-creating project 'fifo_buffer_tb'
#
...
set _xil_proj_name_ "fifo_buffer_tb"
...
set script_file "fifo_buffer_tb.tcl"
...
set files [list \
 [file normalize "${origin_dir}/design/fifo.v"] \
]
...
set files [list \
 [file normalize "${origin_dir}/testbench/fifo_gen.v"] \
 [file normalize "${origin_dir}/testbench/fifo_monitor.v"] \
 [file normalize "${origin_dir}/testbench/fifo_tb.v"] \
]
add_files -norecurse -fileset $obj $files
