...
#
# async_bin_cnt_monitor.tcl: Tcl script for re-creating project 'async_bin_cnt_monitor'
#
...
set _xil_proj_name_ "async_bin_cnt_monitor"
...
set script_file "async_bin_cnt_monitor.tcl"
...
set files [list \
 [file normalize "${origin_dir}/design/univ_bin_counter.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "univ_bin_counter" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/testbench/bin_gen.v"] \
 [file normalize "${origin_dir}/testbench/bin_monitor.v"] \
 [file normalize "${origin_dir}/testbench/bin_counter_tb3.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "bin_counter_tb3" -objects $obj
