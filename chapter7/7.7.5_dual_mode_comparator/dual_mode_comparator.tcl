...
#
# dual_mode_comparator.tcl: Tcl script for re-creating project 'dual_mode_comparator'
#
...
set _xil_proj_name_ "dual_mode_comparator"
...
set script_file "dual_mode_comparator.tcl"
...
set files [list \
 ...
 [file normalize "${origin_dir}/design/signed_comparator.v"] \
 [file normalize "${origin_dir}/design/unsigned_comparator.v"] \
 [file normalize "${origin_dir}/design/comparator_top.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "comparator_top" -objects $obj
