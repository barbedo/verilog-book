...
#
# binary_decoder.tcl: Tcl script for re-creating project 'binary_decoder'
#
...
set script_file "binary_decoder.tcl"
...
# Create project
create_project binary_decoder $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects binary_decoder]
...
puts "INFO: Project created:binary_decoder"
