...
set_property PACKAGE_PIN W16 [get_ports {i0[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i0[2]}]
set_property PACKAGE_PIN W17 [get_ports {i0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i0[3]}]
set_property PACKAGE_PIN W15 [get_ports {i1[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i1[0]}]
set_property PACKAGE_PIN V15 [get_ports {i1[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i1[1]}]
set_property PACKAGE_PIN W14 [get_ports {i1[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i1[2]}]
set_property PACKAGE_PIN W13 [get_ports {i1[3]}]
