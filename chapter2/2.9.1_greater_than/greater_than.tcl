...
#
# greater_than.tcl: Tcl script for re-creating project 'greater_than'
#
...
set _xil_proj_name_ "greater_than"
...
set script_file "greater_than.tcl"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "greater_than_4b" -objects $obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/src/constraints/Basys3_Master.xdc"]" -objects $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "greater_than_4b_tb" -objects $obj
