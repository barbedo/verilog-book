...
# Create project
create_project short_tutorial $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects short_tutorial]
...
puts "INFO: Project created:short_tutorial"
