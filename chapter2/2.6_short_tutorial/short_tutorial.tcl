...
#
# short_tutorial.tcl: Tcl script for re-creating project 'short_tutorial'
#
...
set _xil_proj_name_ "short_tutorial"
...
set script_file "short_tutorial.tcl"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "eq2" -objects $obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/src/Basys3_Master.xdc"]" -objects $obj
