...
#
# heartbeat.tcl: Tcl script for re-creating project 'heartbeat'
#
...
# Create project
create_project heartbeat $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects heartbeat]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/heartbeat.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "heartbeat" $obj
...
puts "INFO: Project created:heartbeat"
