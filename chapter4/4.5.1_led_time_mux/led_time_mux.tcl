...
#
# led_time_mux.tcl: Tcl script for re-creating project 'led_time_mux'
#
...
set script_file "led_time_mux.tcl"
...
# Create project
create_project led_time_mux $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects led_time_mux]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/disp_mux_test.v"]"\
]
...
set obj [get_filesets sim_1]
set_property "top" "disp_mux_test" $obj
...
puts "INFO: Project created:led_time_mux"
