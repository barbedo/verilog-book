...
#
# enh_stopwatch.tcl: Tcl script for re-creating project 'enh_stopwatch'
#
...
set script_file "enh_stopwatch.tcl"
...
# Create project
create_project enh_stopwatch $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects enh_stopwatch]
...
set files [list \
 "[file normalize "$origin_dir/src/design/enh_stop_watch.v"]"\
...
puts "INFO: Project created:enh_stopwatch"
