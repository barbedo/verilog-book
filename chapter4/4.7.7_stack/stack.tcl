...
#
# stack.tcl: Tcl script for re-creating project 'stack'
#
...
# Create project
create_project stack $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 "[file normalize "$origin_dir/src/design/stack.v"]"\
 "[file normalize "$origin_dir/src/design/debounce.v"]"\
 "[file normalize "$origin_dir/src/design/stack_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "stack_test" $obj
...
puts "INFO: Project created:stack"
