...
#
# rot_square.tcl: Tcl script for re-creating project 'rot_square'
#
...
set script_file "rot_square.tcl"
...
# Create project
create_project rot_square $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects rot_square]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/rot_square.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "rot_square" $obj
...
puts "INFO: Project created:rot_square"
