...
set _xil_proj_name_ "square_wave_generator"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "square_wave_gen" -objects $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "square_wave_gen_tb" -objects $obj
