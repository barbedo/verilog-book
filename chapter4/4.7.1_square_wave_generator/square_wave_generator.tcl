...
#
# square_wave_generator.tcl: Tcl script for re-creating project 'square_wave_generator'
#
...
set script_file "square_wave_generator.tcl"
...
# Create project
create_project square_wave_generator $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects square_wave_generator]
...
set files [list \
 "[file normalize "$origin_dir/src/design/square_wave_gen.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "square_wave_gen" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/square_wave_gen_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property "top" "square_wave_gen_tb" $obj
...
puts "INFO: Project created:square_wave_generator"
