...
#
# led_banner.tcl: Tcl script for re-creating project 'led_banner'
#
...
set script_file "led_banner.tcl"
...
# Create project
create_project led_banner $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects led_banner]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/led_banner.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "led_banner" $obj
...
puts "INFO: Project created:led_banner"
