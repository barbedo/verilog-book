...
# Create project
create_project fifo $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/fifo.v"]"\
 "[file normalize "$origin_dir/src/design/fifo_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "fifo_test" $obj
...
set file "[file normalize "$origin_dir/src/contraints/Basys3_Master.xdc"]"
...
puts "INFO: Project created:fifo"
