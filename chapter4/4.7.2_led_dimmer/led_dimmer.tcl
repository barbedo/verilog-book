...
#
# led_dimmer.tcl: Tcl script for re-creating project 'led_dimmer'
#
...
set script_file "led_dimmer.tcl"
...
# Create project
create_project led_dimmer $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects led_dimmer]
...
set files [list \
 "[file normalize "$origin_dir/src/design/pwm.v"]"\
 "[file normalize "$origin_dir/src/design/disp_hex_mux.v"]"\
 "[file normalize "$origin_dir/src/design/hex_mux_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "hex_mux_test" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/pwm_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
puts "INFO: Project created:led_dimmer"
