...
#
# car_park_counter.tcl: Tcl script for re-creating project 'car_park_counter'
#
...
set script_file "car_park_counter.tcl"
...
# Create project
create_project car_park_counter $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects car_park_counter]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/counter.v"]"\
 "[file normalize "$origin_dir/src/design/car_park_sensor.v"]"\
 "[file normalize "$origin_dir/src/design/debounce.v"]"\
 "[file normalize "$origin_dir/src/design/car_park_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "car_park_test" $obj
...
puts "INFO: Project created:car_park_counter"
