...
#
# debouncer.tcl: Tcl script for re-creating project 'debouncer'
#
...
# Create project
create_project debouncer $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects debouncer]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/db_fsm.v"]"\
 "[file normalize "$origin_dir/src/design/debounce_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "debounce_test" $obj
...
puts "INFO: Project created:debouncer"
