...
#
# dual_edge.tcl: Tcl script for re-creating project 'dual_edge'
#
...
# Create project
create_project dual_edge $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects dual_edge]
...
set files [list \
 "[file normalize "$origin_dir/src/design/dual_edge_moore.v"]"\
 "[file normalize "$origin_dir/src/design/dual_edge_mealy.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "dual_edge_moore" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/dual_edge_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
puts "INFO: Project created:dual_edge"
