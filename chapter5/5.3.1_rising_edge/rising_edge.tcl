...
#
# rising_edge.tcl: Tcl script for re-creating project 'rising_edge'
#
...
set script_file "rising_edge.tcl"
...
# Create project
create_project rising_edge $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects rising_edge]
...
set files [list \
 "[file normalize "$origin_dir/src/design/edge_detect_mealy.v"]"\
 "[file normalize "$origin_dir/src/design/edge_detect_moore.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "edge_detect_mealy" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/edge_detect_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property "top" "edge_detect_tb" $obj
...
puts "INFO: Project created:rising_edge"
