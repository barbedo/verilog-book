...
#
# hex_to_sseg.tcl: Tcl script for re-creating project 'hex_to_sseg'
#
...
set script_file "hex_to_sseg.tcl"
...
# Create project
create_project hex_to_sseg $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects hex_to_sseg]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/hex_to_sseg_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "hex_to_sseg_test" $obj
...
puts "INFO: Project created:hex_to_sseg"
