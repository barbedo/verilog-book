...
#
# dual_prio_encoder.tcl: Tcl script for re-creating project 'dual_prio_encoder'
#
...
set script_file "dual_prio_encoder.tcl"
...
# Create project
create_project dual_prio_encoder $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects dual_prio_encoder]
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/dual_prio_encoder.v"]"\
 "[file normalize "$origin_dir/src/design/dual_prio_encoder_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "dual_prio_test" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/dual_prio_encoder_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property "top" "dual_prio_encoder_tb" $obj
...
puts "INFO: Project created:dual_prio_encoder"
