...
set _xil_proj_name_ "dual_prio_encoder"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "dual_prio_test" -objects $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "dual_prio_encoder_tb" -objects $obj
