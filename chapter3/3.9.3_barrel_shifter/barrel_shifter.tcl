...
#
# barrel_shifter.tcl: Tcl script for re-creating project 'barrel_shifter'
#
...
set script_file "barrel_shifter.tcl"
...
# Create project
create_project barrel_shifter $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects barrel_shifter]
...
set files [list \
 "[file normalize "$origin_dir/src/design/barrel_shifter_stage.v"]"\
 "[file normalize "$origin_dir/src/design/shifter_test.v"]"\
 "[file normalize "$origin_dir/src/design/barrel_shifter_case.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "shifter_test" $obj
...
puts "INFO: Project created:barrel_shifter"
