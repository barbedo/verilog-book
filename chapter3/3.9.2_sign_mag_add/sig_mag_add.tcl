...
set script_file "sig_mag_add.tcl"
...
# Create project
create_project sig_mag_add $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects sig_mag_add]
...
set obj [get_filesets sources_1]
set_property "top" "sm_add_test" $obj
...
puts "INFO: Project created:sig_mag_add"
