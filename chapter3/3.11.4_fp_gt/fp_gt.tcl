...
#
# fp_gt.tcl: Tcl script for re-creating project 'fp_gt'
#
...
# Create project
create_project fp_gt $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 "[file normalize "$origin_dir/src/design/fp_gt.v"]"\
 "[file normalize "$origin_dir/src/design/fp_gt_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "fp_gt_test" $obj
...
set files [list \
 "[file normalize "$origin_dir/src/testbench/fp_gt_tb.v"]"\
]
add_files -norecurse -fileset $obj $files
...
puts "INFO: Project created:fp_gt"
