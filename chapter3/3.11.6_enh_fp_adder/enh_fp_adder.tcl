...
#
# enh_fp_adder.tcl: Tcl script for re-creating project 'enh_fp_adder'
#
...
set script_file "enh_fp_adder.tcl"
...
# Create project
create_project enh_fp_adder $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set obj [get_projects enh_fp_adder]
...
set files [list \
 "[file normalize "$origin_dir/src/design/enh_fp_adder.v"]"\
 "[file normalize "$origin_dir/src/design/disp_mux.v"]"\
 "[file normalize "$origin_dir/src/design/hex_to_sseg.v"]"\
 "[file normalize "$origin_dir/src/design/enh_fp_adder_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "enh_fp_adder_test" $obj
...
puts "INFO: Project created:enh_fp_adder"
