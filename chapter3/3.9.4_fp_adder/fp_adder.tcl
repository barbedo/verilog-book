...
#
# fp_adder.tcl: Tcl script for re-creating project 'fp_adder'
#
...
# Create project
create_project fp_adder $origin_dir/work -part xc7a35tcpg236-1 -quiet -force
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/design/fp_adder.v"]"\
 "[file normalize "$origin_dir/src/design/fp_adder_test.v"]"\
]
...
set obj [get_filesets sources_1]
set_property "top" "fp_adder_test" $obj
...
puts "INFO: Project created:fp_adder"
